...
![alt text](../images/2024-12-26-modern%20C++/image-1.png)
...
> 本质上是一种递归的处理。首先写出base版本，即可以终止递归的基础函数，然后在写一个调用它的递归函数，其中递归部分的参数是不确定的，采用可变参数表示。编译器在这个过程中会帮我们展开递归，并生成对应参数个数的重载函数![alt text](../images/2024-12-26-modern%20C++/image-5.png)
...
#### concept
![alt text](../images/2024-12-26-modern%20C++/image-2.png)
为了应用这个约束，可以按照如下方式
```
...
```
c++有一些内置的concept
![alt text](../images/2024-12-26-modern%20C++/image-3.png)

同样的，针对迭代器也有一些concept
![alt text](../images/2024-12-26-modern%20C++/image-4.png)

### 模版元编程
利用模版的类型推导来做一些将程序放到编译时执行的优化，比如通过模版计算斐波那契数列
![alt text](../images/2024-12-26-modern%20C++/image-7.png)
### constexp/consteval 
因为模版元编程可能语法不太美丽，可以采用这种方式提醒编译器，可以在编译时计算该常量表达式
![alt text](../images/2024-12-26-modern%20C++/image-8.png)
...
### lambda function
![alt text](../images/2024-12-26-modern%20C++/image-9.png)
...
![alt text](../images/2024-12-26-modern%20C++/image.png)
...
### view
view是一种对range的惰性处理，包含filter,tranform等操作，这些操作不会对原本的容器做修改抑或是生成新的对象，只是对现有range执行操作并返回操作后的视图。![alt text](../images/2024-12-26-modern%20C++/image-10.png)
...
![alt text](../images/2024-12-26-modern%20C++/image-11.png)
